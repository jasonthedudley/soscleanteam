Public Class UsersAndRoles
    ...
    Protected Sub RolesUserList_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles RolesUserList.RowDeleting
        ' Get the selected role 
        Dim selectedRoleName As String = RoleList.SelectedValue
    ...
    Protected Sub AddUserToRoleButton_Click(sender As Object, e As EventArgs) Handles AddUserToRoleButton.Click
