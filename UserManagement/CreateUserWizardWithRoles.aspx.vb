Public Class CreateUserWizardWithRoles
    ...
    Protected Sub RegisterUserWithRoles_ActiveStepChanged(sender As Object, e As EventArgs) Handles RegisterUserWithRoles.ActiveStepChanged
